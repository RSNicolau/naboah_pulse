...
import { History, ShieldCheck, User, RotateCcw, ArrowRight, Database, FileCheck } from 'lucide-react';
        ...
        <div className="bg-bg-1 border border-stroke rounded-[3rem] p-12 flex flex-col gap-10 shadow-2xl relative overflow-hidden">
            ...
            <div className="p-8 bg-secondary/5 border border-secondary/10 rounded-[2.5rem] flex items-center gap-6">
                ...
                <div className="flex flex-col">
                    <span className="text-[9px] font-black text-text-3 uppercase tracking-widest">DRM & Lincensing Status</span>
                    <span className="text-xs font-black text-white italic">Full Commercial Usage Rights (Sourced via Pulse Neural)</span>
                </div>
            </div>
