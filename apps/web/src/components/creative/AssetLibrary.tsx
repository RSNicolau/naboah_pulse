...
import { Image as ImageIcon, Video, Music, ShieldCheck, Download, Info, History, Trash2, Tag } from 'lucide-react';

export default function AssetLibrary() {
    const assets = [
        { id: '1', title: 'Luxury Watch - Neon Scene', type: 'image', url: 'https://images.unsplash.com/photo-1523275335684-37898b6baf30', date: '5m ago', risk: '0.02', status: 'Approved' },
        { id: '2', title: 'Urban Lifestyle Promo', type: 'video', url: '#', date: '2h ago', risk: '0.05', status: 'Needs Review' },
        { id: '3', title: 'Streetwear Drop - B&W', type: 'image', url: 'https://images.unsplash.com/photo-1543163521-1bf539c55dd2', date: '1d ago', risk: '0.01', status: 'Approved' },
    ];
                    ...
                    <div key={asset.id} className="group relative bg-bg-1 border border-stroke rounded-[2.5rem] overflow-hidden hover:border-primary/40 transition-all shadow-2xl">
                        ...
                        <div className="aspect-[4/5] bg-bg-0 relative overflow-hidden">
                            ...
                            <div className="absolute top-6 left-6 px-3 py-1 bg-black/60 backdrop-blur-md border border-white/10 rounded-full flex items-center gap-2">
                                <span className={`w-1.5 h-1.5 rounded-full ${asset.status === 'Approved' ? 'bg-success' : 'bg-warning'}`}></span>
                        ...
                        <div className="p-8 flex flex-col gap-6">
                            <div className="flex flex-col gap-1">
                                ...
                                <div className="flex items-center gap-4">
                                    <span className="text-[9px] font-bold text-text-3 uppercase tracking-widest">{asset.date}</span>
                                    <span className="text-[9px] font-bold text-primary uppercase tracking-widest">Risk: {asset.risk}</span>
                                </div>
                            </div>
