...
import { Building2, ShieldCheck, Activity, Terminal, Database, Send, Users, ChevronRight } from 'lucide-react';
                    ...
                    <div className="bg-bg-1 border border-stroke rounded-[3rem] p-10 flex flex-col gap-8 shadow-xl relative overflow-hidden">
                        <div className="flex flex-col gap-6">
                            <div className="flex items-center justify-between">
                                <div className="flex flex-col gap-1">
                                    ...
                                    <h4 className="text-lg font-black text-white uppercase italic">Residência de Dados</h4>
                                </div>
                            ...
                            <div className="flex flex-col gap-3">
                                {[
                                    { region: 'Brasil (Local)', usage: '74%', status: 'Compliant' },
                                    { region: 'União Europeia', usage: '12%', status: 'Compliant' },
                                    { region: 'Resto do Mundo', usage: '14%', status: 'Proxying' },
                                ].map((reg, i) => (
                        ...
                        <div className="flex flex-col gap-6 pt-8 border-t border-white/5">
                            ...
                            <p className="text-[10px] text-text-2 leading-relaxed">
                                Transmissão ativa para: **https://siem.enterprise.corp/events**.
                                Filtros ativos: Auth, Billing, Data_Access.
                            </p>
                    ...
                    <div className="bg-gradient-to-br from-secondary/20 to-bg-1 border border-secondary/20 rounded-[3rem] p-8 flex items-center justify-between group cursor-pointer shadow-2xl">
                        <div className="flex items-center gap-4">
                            ...
                            <div className="flex flex-col">
                                ...
                                <h4 className="text-sm font-black text-white uppercase">RBAC Avançado</h4>
                            </div>
                        </div>
